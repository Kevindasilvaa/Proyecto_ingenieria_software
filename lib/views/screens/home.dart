    ...
    child: Column(
      ...
      children: [
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Text(
                ...
                style: const TextStyle(
                    fontSize: 30, fontWeight: FontWeight.bold, color: Colors.white), // Texto blanco
              );
            }
          },
        ),
        ...
        StreamBuilder<List<Transaccion>>(
          stream: TransaccionesController().obtenerTransaccionesUsuarioStream(),
          builder: (context, snapshot) {
            ...
            return BudgetLink(
              ...
              presupuestoMensual: userController.usuario?.monthlyExpenseBudget ?? 0,
                      ...
                      children: [
                        Container(
                          decoration: BoxDecoration(
                            color: Colors.green.withOpacity(0.8), // Opacidad incrementada para mejor visibilidad
                            shape: BoxShape.circle,
                          ),
                          padding: const EdgeInsets.all(4), // Padding ligeramente aumentado para más equilibrio
                          child: const Icon(
                            Icons.arrow_upward,
                            color: Colors.white, // Cambié a blanco para mayor contraste
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          decoration: BoxDecoration(
                            color: Colors.red.withOpacity(0.8), // Opacidad incrementada para mejor visibilidad
                            shape: BoxShape.circle,
                          ),
                          padding: const EdgeInsets.all(4), // Padding ligeramente aumentado para mejor equilibrio
                          child: const Icon(
